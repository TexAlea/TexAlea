...
\textbf{1.} Place, le plus précisément possible, le point $G$ d'abscisse $0.11$ \textbf{sur chacun des trois axes} ci-dessous.

\vfill

{} \hfill 
\axesZoom{0.11}{G}{0}{false}{true}
\hfill {}

\vfill

\textbf{2.} Place, le plus précisément possible, le point $J (8.35)$ \textbf{sur chacun des trois axes} ci-dessous.

\vfill

{} \hfill 
\axesZoom{8.35}{J}{0}{false}{true}
\hfill {}

\vfill

\textbf{3.} Place, le plus précisément possible, le point $S$ tel que $x_{S}=7.6$ sur chacun des axes ci-dessous.

\vfill

{} \hfill 
\axesZoom{7.6}{S}{0}{false}{true}
\hfill {}
...
\textbf{1.} Place, le plus précisément possible, le point $J$ d'abscisse $5.72$ \textbf{sur chacun des trois axes} ci-dessous.

\vfill

{} \hfill 
\axesZoom{5.72}{J}{0}{false}{true}
\hfill {}

\vfill

\textbf{2.} Place, le plus précisément possible, le point $G (5.47)$ \textbf{sur chacun des trois axes} ci-dessous.

\vfill

{} \hfill 
\axesZoom{5.47}{G}{0}{false}{true}
\hfill {}

\vfill

\textbf{3.} Place, le plus précisément possible, le point $M$ tel que $x_{M}=2.83$ sur chacun des axes ci-dessous.

\vfill

{} \hfill 
\axesZoom{2.83}{M}{0}{false}{true}
\hfill {}
...
\textbf{1.} Place, le plus précisément possible, le point $D$ d'abscisse $4.47$ \textbf{sur chacun des trois axes} ci-dessous.

\vfill

{} \hfill 
\axesZoom{4.47}{D}{0}{false}{true}
\hfill {}

\vfill

\textbf{2.} Place, le plus précisément possible, le point $Y (4.08)$ \textbf{sur chacun des trois axes} ci-dessous.

\vfill

{} \hfill 
\axesZoom{4.08}{Y}{0}{false}{true}
\hfill {}

\vfill

\textbf{3.} Place, le plus précisément possible, le point $Z$ tel que $x_{Z}=8.48$ sur chacun des axes ci-dessous.

\vfill

{} \hfill 
\axesZoom{8.48}{Z}{0}{false}{true}
\hfill {}
...
\textbf{1.} Place, le plus précisément possible, le point $W$ d'abscisse $3.28$ \textbf{sur chacun des trois axes} ci-dessous.

\vfill

{} \hfill 
\axesZoom{3.28}{W}{0}{false}{true}
\hfill {}

\vfill

\textbf{2.} Place, le plus précisément possible, le point $U (9.59)$ \textbf{sur chacun des trois axes} ci-dessous.

\vfill

{} \hfill 
\axesZoom{9.59}{U}{0}{false}{true}
\hfill {}

\vfill

\textbf{3.} Place, le plus précisément possible, le point $V$ tel que $x_{V}=0.83$ sur chacun des axes ci-dessous.

\vfill

{} \hfill 
\axesZoom{0.83}{V}{0}{false}{true}
\hfill {}
